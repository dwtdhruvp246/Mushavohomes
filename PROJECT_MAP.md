# Mushavo Homes Project Map

This map helps future agents find the right file quickly without scanning the whole project.

## Architecture At A Glance

Mushavo Homes is currently a static multi-page HTML application backed by Supabase.
...
| Existing database patch | `existing_database_patch.sql` | Idempotent SQL changes to run against the current hosted Supabase database; keep aligned with the master schema |
